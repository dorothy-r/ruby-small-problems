=begin
A friend of yours want to build a basic search engine and starts reading up on
...
numbers do not match what is expected. He know you're enrolled in an awesome
...
def idf(term, documents)
  ...
  return 0 if number_of_documents_with_term == 0  #avoids ZeroDivision error

  Math.log(number_of_documents.to_f / number_of_documents_with_term)
  # just need to make sure we are not doing integer division here
end
